...
export default class App extends React.Component{
  constructor(){
    ...
    this.state = {
      ...
      projects: [
        {  title: "ResuScan Resume Analyzer", type: "Frontend & Backend", image: activeProject, description: "Come see what I'm currently developing!", techUsed: ["Typescript", "React", "Python", "Django Backend", "MySQL", "AWS-S3", "OpenAI", "LLMs", "JWT-Auth" ],  dateCreated: "2025", link: "https://jorgeramirez.net/resuscan", gitHub: "", youtube: "", notAvailable: 0},
